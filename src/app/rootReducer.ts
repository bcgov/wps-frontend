...
import forecastsReducer from 'features/weatherForecast/slices/ForecastsSlice'
import actualsReducer from 'features/weatherForecast/slices/ActualsSlice'
...
export const selectActuals = (state: RootState) => state.actuals
